    ...
    namespace details
    {
        ...
        static std::map<web::uri, web::json::value> make_is05_schemas()
        {
            ...
            return
            {
                ...
                { make_schema_uri(v1_2::tag, _XPLATSTR("sender_transport_params_mxl.json")), make_schema(v1_2::sender_transport_params_usb) },
                ...
                { make_schema_uri(v1_2::tag, _XPLATSTR("receiver_transport_params_mxl.json")), make_schema(v1_2::receiver_transport_params_usb) },
