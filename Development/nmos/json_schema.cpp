    ...
    namespace details
    {
        ...
        static std::map<web::uri, web::json::value> make_is05_schemas()
        {
            ...
            return
            {
                ...
                { make_schema_uri(v1_1::tag, _XPLATSTR("sender_transport_params_usb.json")), make_schema(v1_1::sender_transport_params_usb) },
                ...
                { make_schema_uri(v1_1::tag, _XPLATSTR("receiver_transport_params_usb.json")), make_schema(v1_1::receiver_transport_params_usb) },
